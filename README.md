...
*JSAPIAuthTypesApi* | [**deleteType**](docs/JSAPIAuthTypesApi.md#deletetype) | **DELETE** /access/types/{type} | Delete a root type
...
*JSAPILevelingApi* | [**deleteLevelingTemplate**](docs/JSAPILevelingApi.md#deletelevelingtemplate) | **DELETE** /leveling/templates/{id} | Delete a leveling template
...
*JSAPIMonitoringApi* | [**deleteIncident**](docs/JSAPIMonitoringApi.md#deleteincident) | **DELETE** /monitoring/incidents/{id} | End an existing incident
...
*JSAPISearchApi* | [**indexDocument**](docs/JSAPISearchApi.md#indexdocument) | **POST** /search/documents | Adds a document to be indexed. For system use only.
*JSAPISearchApi* | [**reindexAll**](docs/JSAPISearchApi.md#reindexall) | **POST** /search/reindex | Triggers a full re-indexing of all documents of the specified type. For system use only.
*JSAPISearchApi* | [**removeDocument**](docs/JSAPISearchApi.md#removedocument) | **DELETE** /search/documents | Remove a document from the index. For system use only.
...
*JSAPISearchApi* | [**searchPublicIndex**](docs/JSAPISearchApi.md#searchpublicindex) | **POST** /search/public/{type} | Search public index with no template
...
*JSAPIStoreApi* | [**quickNew**](docs/JSAPIStoreApi.md#quicknew) | **POST** /store/quick-new | One-step invoice creation
*JSAPIStoreApi* | [**quickPaid**](docs/JSAPIStoreApi.md#quickpaid) | **POST** /store/quick-paid | One-step purchase when already paid
*JSAPIStoreApi* | [**quickProcessing**](docs/JSAPIStoreApi.md#quickprocessing) | **POST** /store/quick-processing | One-step invoice creation when already processing
*JSAPIStoreApi* | [**updateItemTemplate**](docs/JSAPIStoreApi.md#updateitemtemplate) | **PATCH** /store/items/templates/{id} | Update an item template
...
*JSAPIStoreBundlesApi* | [**updateBundleTemplate**](docs/JSAPIStoreBundlesApi.md#updatebundletemplate) | **PATCH** /store/bundles/templates/{id} | Update a bundle template
...
*JSAPIStoreCouponsApi* | [**updateCouponTemplate**](docs/JSAPIStoreCouponsApi.md#updatecoupontemplate) | **PATCH** /store/coupons/templates/{id} | Update a coupon template
...
*JSAPIStoreShippingApi* | [**updateShippingTemplate**](docs/JSAPIStoreShippingApi.md#updateshippingtemplate) | **PATCH** /store/shipping/templates/{id} | Update a shipping template
...
*JSAPIStoreSubscriptionsApi* | [**updateSubscriptionTemplate**](docs/JSAPIStoreSubscriptionsApi.md#updatesubscriptiontemplate) | **PATCH** /subscriptions/templates/{id} | Update a subscription template
...
*JSAPIStoreVendorsApi* | [**updateVendorTemplate**](docs/JSAPIStoreVendorsApi.md#updatevendortemplate) | **PATCH** /vendors/templates/{id} | Update a vendor template
...
*JSAPITemplatesApi* | [**createTemplate**](docs/JSAPITemplatesApi.md#createtemplate) | **POST** /templates/{type_hint} | Create a template
*JSAPITemplatesApi* | [**deleteTemplate**](docs/JSAPITemplatesApi.md#deletetemplate) | **DELETE** /templates/{type_hint}/{id} | Delete a template
*JSAPITemplatesApi* | [**getTemplate**](docs/JSAPITemplatesApi.md#gettemplate) | **GET** /templates/{type_hint}/{id} | Get a template
*JSAPITemplatesApi* | [**getTemplates**](docs/JSAPITemplatesApi.md#gettemplates) | **GET** /templates/{type_hint} | List and search templates
*JSAPITemplatesApi* | [**patchTemplate**](docs/JSAPITemplatesApi.md#patchtemplate) | **PATCH** /templates/{type_hint}/{id} | Patch a template
*JSAPITemplatesApi* | [**validate**](docs/JSAPITemplatesApi.md#validate) | **POST** /templates/{type_hint}/validate | Validate a templated resource
...
*JSAPIUsersApi* | [**updateUserTemplate**](docs/JSAPIUsersApi.md#updateusertemplate) | **PATCH** /users/templates/{id} | Update a user template
...
*JSAPIUsersGroupsApi* | [**createGroupMemberTemplate**](docs/JSAPIUsersGroupsApi.md#creategroupmembertemplate) | **POST** /users/groups/members/templates | Create a group member template
...
*JSAPIUsersGroupsApi* | [**deleteGroupMemberTemplate**](docs/JSAPIUsersGroupsApi.md#deletegroupmembertemplate) | **DELETE** /users/groups/members/templates/{id} | Delete a group member template
...
*JSAPIUsersGroupsApi* | [**updateGroupMemberOrder**](docs/JSAPIUsersGroupsApi.md#updategroupmemberorder) | **PUT** /users/groups/{unique_name}/members/{user_id}/order | Change a user&#39;s order
*JSAPIUsersGroupsApi* | [**updateGroupMemberProperties**](docs/JSAPIUsersGroupsApi.md#updategroupmemberproperties) | **PUT** /users/groups/{unique_name}/members/{user_id}/properties | Change a user&#39;s membership properties
...
*JSAPIUsersGroupsApi* | [**updateGroupMemberTemplate**](docs/JSAPIUsersGroupsApi.md#updategroupmembertemplate) | **PATCH** /users/groups/members/templates/{id} | Update a group member template
*JSAPIUsersGroupsApi* | [**updateGroupTemplate**](docs/JSAPIUsersGroupsApi.md#updategrouptemplate) | **PATCH** /users/groups/templates/{id} | Update a group template
...
*JSAPIUsersInventoryApi* | [**getInventoryList**](docs/JSAPIUsersInventoryApi.md#getinventorylist) | **GET** /inventories | List the user inventory entries for all users
...
*JSAPIUsersInventoryApi* | [**updateEntitlementTemplate**](docs/JSAPIUsersInventoryApi.md#updateentitlementtemplate) | **PATCH** /entitlements/templates/{id} | Update an entitlement template
...
*JSAPIUsersRelationshipsApi* | [**getRelationship**](docs/JSAPIUsersRelationshipsApi.md#getrelationship) | **GET** /users/relationships/{id} | Get a user relationship
...
*JSAPIVerificationApi* | [**createRequestTemplate**](docs/JSAPIVerificationApi.md#createrequesttemplate) | **POST** /verification/templates | Create a request template
*JSAPIVerificationApi* | [**createVerificationRequest**](docs/JSAPIVerificationApi.md#createverificationrequest) | **POST** /verification/requests | Create a new request
*JSAPIVerificationApi* | [**deleteRequestTemplate**](docs/JSAPIVerificationApi.md#deleterequesttemplate) | **DELETE** /verification/templates/{id} | Delete a request template
*JSAPIVerificationApi* | [**deleteVerificationRequest**](docs/JSAPIVerificationApi.md#deleteverificationrequest) | **DELETE** /verification/requests/{code} | Delete an existing request
*JSAPIVerificationApi* | [**getRequestTemplate**](docs/JSAPIVerificationApi.md#getrequesttemplate) | **GET** /verification/templates/{id} | Get a single request template
*JSAPIVerificationApi* | [**getRequestTemplates**](docs/JSAPIVerificationApi.md#getrequesttemplates) | **GET** /verification/templates | List and search request templates
*JSAPIVerificationApi* | [**getVerificationRequest**](docs/JSAPIVerificationApi.md#getverificationrequest) | **GET** /verification/requests/{code} | Get a single verification request
*JSAPIVerificationApi* | [**getVerificationRequests**](docs/JSAPIVerificationApi.md#getverificationrequests) | **GET** /verification/requests | List requests
*JSAPIVerificationApi* | [**updateRequestTemplate**](docs/JSAPIVerificationApi.md#updaterequesttemplate) | **PATCH** /verification/templates/{id} | Update a request template
*JSAPIVerificationApi* | [**updateVerificationRequest**](docs/JSAPIVerificationApi.md#updateverificationrequest) | **PUT** /verification/requests/{code} | Update an existing request
*JSAPIVerificationApi* | [**verifyRequest**](docs/JSAPIVerificationApi.md#verifyrequest) | **POST** /verification/requests/{code}/responses | Verify a request


## Documentation For Models

 - [JSAPIAccessEntryResource](docs/JSAPIAccessEntryResource.md)
 - [JSAPIAccessResourceCreateRequest](docs/JSAPIAccessResourceCreateRequest.md)
 - [JSAPIAccessResultsResource](docs/JSAPIAccessResultsResource.md)
 - [JSAPIAccessSubTypeResource](docs/JSAPIAccessSubTypeResource.md)
 - [JSAPIAccessTypeResource](docs/JSAPIAccessTypeResource.md)
 ...
 - [JSAPIClientCustomizationResource](docs/JSAPIClientCustomizationResource.md)
 ...
 - [JSAPIDocumentRemoveRequest](docs/JSAPIDocumentRemoveRequest.md)
 ...
 - [JSAPIInnerQuery](docs/JSAPIInnerQuery.md)
 ...
 - [JSAPILongWrapper](docs/JSAPILongWrapper.md)
 ...
 - [JSAPIMonitoringAlertLevel](docs/JSAPIMonitoringAlertLevel.md)
 - [JSAPIMonitoringAlertResource](docs/JSAPIMonitoringAlertResource.md)
 - [JSAPIMonitoringIncidentEventResource](docs/JSAPIMonitoringIncidentEventResource.md)
 - [JSAPIMonitoringIncidentLevelResource](docs/JSAPIMonitoringIncidentLevelResource.md)
 - [JSAPIMonitoringIncidentResource](docs/JSAPIMonitoringIncidentResource.md)
 - [JSAPIMonitoringMetricDatapointResource](docs/JSAPIMonitoringMetricDatapointResource.md)
 - [JSAPIMonitoringMetricResource](docs/JSAPIMonitoringMetricResource.md)
 ...
 - [JSAPIOAuth2ProviderResource](docs/JSAPIOAuth2ProviderResource.md)
 ...
 - [JSAPIPageResourceAccessResultsResource_](docs/JSAPIPageResourceAccessResultsResource_.md)
 - [JSAPIPageResourceAccessTypeResource_](docs/JSAPIPageResourceAccessTypeResource_.md)
 - [JSAPIPageResourceAchievementDefinitionResource_](docs/JSAPIPageResourceAchievementDefinitionResource_.md)
 - [JSAPIPageResourceActionResource_](docs/JSAPIPageResourceActionResource_.md)
 ...
 - [JSAPIPageResourceAnswerResource_](docs/JSAPIPageResourceAnswerResource_.md)
 ...
 - [JSAPIPageResourceBehaviorDefinitionResource_](docs/JSAPIPageResourceBehaviorDefinitionResource_.md)
 ...
 - [JSAPIPageResourceChatBlacklistResource_](docs/JSAPIPageResourceChatBlacklistResource_.md)
 ...
 - [JSAPIPageResourceCountryResource_](docs/JSAPIPageResourceCountryResource_.md)
 ...
 - [JSAPIPageResourceDeltaResource_](docs/JSAPIPageResourceDeltaResource_.md)
 - [JSAPIPageResourceDeviceResource_](docs/JSAPIPageResourceDeviceResource_.md)
 - [JSAPIPageResourceDispositionCount_](docs/JSAPIPageResourceDispositionCount_.md)
 ...
 - [JSAPIPageResourceExpressionResource_](docs/JSAPIPageResourceExpressionResource_.md)
 ...
 - [JSAPIPageResourceGrantTypeResource_](docs/JSAPIPageResourceGrantTypeResource_.md)
 ...
 - [JSAPIPageResourceInventorySubscriptionResource_](docs/JSAPIPageResourceInventorySubscriptionResource_.md)
 ...
 - [JSAPIPageResourceMonitoringAlertResource_](docs/JSAPIPageResourceMonitoringAlertResource_.md)
 - [JSAPIPageResourceMonitoringIncidentEventResource_](docs/JSAPIPageResourceMonitoringIncidentEventResource_.md)
 - [JSAPIPageResourceMonitoringIncidentResource_](docs/JSAPIPageResourceMonitoringIncidentResource_.md)
 - [JSAPIPageResourceMonitoringMetricResource_](docs/JSAPIPageResourceMonitoringMetricResource_.md)
 ...
 - [JSAPIPageResourceOAuth2ProviderResource_](docs/JSAPIPageResourceOAuth2ProviderResource_.md)
 ...
 - [JSAPIPageResourcePaymentMethodResource_](docs/JSAPIPageResourcePaymentMethodResource_.md)
 ...
 - [JSAPIPageResourcePropertyFieldListResource_](docs/JSAPIPageResourcePropertyFieldListResource_.md)
 ...
 - [JSAPIPageResourceSearchDocument_](docs/JSAPIPageResourceSearchDocument_.md)
 ...
 - [JSAPIPageResourceStateResource_](docs/JSAPIPageResourceStateResource_.md)
 ...
 - [JSAPIPageResourceUserSidResource_](docs/JSAPIPageResourceUserSidResource_.md)
 - [JSAPIPageResourceVariableTypeResource_](docs/JSAPIPageResourceVariableTypeResource_.md)
 - [JSAPIPageResourceVendorResource_](docs/JSAPIPageResourceVendorResource_.md)
 - [JSAPIPageResourceVerificationRequest_](docs/JSAPIPageResourceVerificationRequest_.md)
 ...
 - [JSAPIPasswordChangeRequest](docs/JSAPIPasswordChangeRequest.md)
 - [JSAPIPasswordResetRequest](docs/JSAPIPasswordResetRequest.md)
 - [JSAPIPatchActionResource](docs/JSAPIPatchActionResource.md)
 - [JSAPIPatchResource](docs/JSAPIPatchResource.md)
 ...
 - [JSAPIQuickPaidRequest](docs/JSAPIQuickPaidRequest.md)
 ...
 - [JSAPIReindexRequest](docs/JSAPIReindexRequest.md)
 ...
 - [JSAPISearchDocument](docs/JSAPISearchDocument.md)
 - [JSAPISearchQuery](docs/JSAPISearchQuery.md)
 ...
 - [JSAPIVerificationRequest](docs/JSAPIVerificationRequest.md)
