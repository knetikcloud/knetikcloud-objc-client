#import "JSAPIUsersRelationshipsApi.h"
...
@interface JSAPIUsersRelationshipsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIUsersRelationshipsApi

NSString* kJSAPIUsersRelationshipsApiErrorDomain = @"JSAPIUsersRelationshipsApiErrorDomain";
NSInteger kJSAPIUsersRelationshipsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createUserRelationshipWithRelationship: (JSAPIUserRelationshipResource*) relationship
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/relationships"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIUserRelationshipResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIUserRelationshipResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteUserRelationshipWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIUsersRelationshipsApiErrorDomain code:kJSAPIUsersRelationshipsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/relationships/{id}"];
...
///
///  @returns JSAPIPageResourceUserRelationshipResource_*
///
-(NSURLSessionTask*) getUserRelationshipsWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceUserRelationshipResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceUserRelationshipResource_*)data, error);
                                }
                            }];
}
