#import "JSAPIPaymentsXsollaApi.h"
...
@interface JSAPIPaymentsXsollaApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIPaymentsXsollaApi

NSString* kJSAPIPaymentsXsollaApiErrorDomain = @"JSAPIPaymentsXsollaApiErrorDomain";
NSInteger kJSAPIPaymentsXsollaApiMissingParamErrorCode = 234513;
