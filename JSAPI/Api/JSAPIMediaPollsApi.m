...
@interface JSAPIMediaPollsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIMediaPollsApi

NSString* kJSAPIMediaPollsApiErrorDomain = @"JSAPIMediaPollsApiErrorDomain";
NSInteger kJSAPIMediaPollsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) answerPollWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIMediaPollsApiErrorDomain code:kJSAPIMediaPollsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/polls/{id}/response"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIPollResponseResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPollResponseResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createPollWithPollResource: (JSAPIPollResource*) pollResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/polls"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPollResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPollResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createPollTemplateWithPollTemplateResource: (JSAPITemplateResource*) pollTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/polls/templates"];
...
-(NSURLSessionTask*) deletePollWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/polls/{id}"];
...
-(NSURLSessionTask*) deletePollTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/polls/templates/{id}"];
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourcePollResource_*
///
-(NSURLSessionTask*) getPollsWithFilterCategory: (NSString*) filterCategory
    ...
    if (filterText != nil) {
        queryParams[@"filter_text"] = filterText;
    }
    if (size != nil) {
        queryParams[@"size"] = size;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourcePollResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourcePollResource_*)data, error);
                                }
                            }];
}
