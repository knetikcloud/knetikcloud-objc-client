#import "JSAPIContentArticlesApi.h"
...
@interface JSAPIContentArticlesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIContentArticlesApi

NSString* kJSAPIContentArticlesApiErrorDomain = @"JSAPIContentArticlesApiErrorDomain";
NSInteger kJSAPIContentArticlesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createArticleWithArticleResource: (JSAPIArticleResource*) articleResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/articles"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIArticleResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIArticleResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createArticleTemplateWithArticleTemplateResource: (JSAPITemplateResource*) articleTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/articles/templates"];
...
-(NSURLSessionTask*) deleteArticleWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/articles/{id}"];
...
-(NSURLSessionTask*) deleteArticleTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/articles/templates/{id}"];
...
-(NSURLSessionTask*) getArticlesWithFilterActiveOnly: (NSNumber*) filterActiveOnly
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceArticleResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceArticleResource_*)data, error);
                                }
                            }];
}
