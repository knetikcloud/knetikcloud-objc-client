...
@interface JSAPICampaignsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPICampaignsApi

NSString* kJSAPICampaignsApiErrorDomain = @"JSAPICampaignsApiErrorDomain";
NSInteger kJSAPICampaignsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addChallengeToCampaignWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPICampaignsApiErrorDomain code:kJSAPICampaignsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{id}/challenges"];
...
-(NSURLSessionTask*) createCampaignWithCampaignResource: (JSAPICampaignResource*) campaignResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPICampaignResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPICampaignResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createCampaignTemplateWithCampaignTemplateResource: (JSAPITemplateResource*) campaignTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/templates"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = campaignTemplateResource;
...
-(NSURLSessionTask*) deleteCampaignWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{id}"];
...
-(NSURLSessionTask*) deleteCampaignTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/templates/{id}"];
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceCampaignResource_*
///
-(NSURLSessionTask*) getCampaignsWithFilterActive: (NSNumber*) filterActive
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceCampaignResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceCampaignResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) removeChallengeFromCampaignWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaign_id}/challenges/{id}"];
