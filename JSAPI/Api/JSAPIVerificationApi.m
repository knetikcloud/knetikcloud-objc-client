...
@interface JSAPIVerificationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIVerificationApi

NSString* kJSAPIVerificationApiErrorDomain = @"JSAPIVerificationApiErrorDomain";
NSInteger kJSAPIVerificationApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createRequestTemplateWithRequestTemplateResource: (JSAPITemplateResource*) requestTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/verification/templates"];
    ...
    bodyParam = requestTemplateResource;
...
-(NSURLSessionTask*) deleteRequestTemplateWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIVerificationApiErrorDomain code:kJSAPIVerificationApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/verification/templates/{id}"];
...
-(NSURLSessionTask*) deleteVerificationRequestWithCode: (NSString*) code
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/verification/requests/{code}"];
...
-(NSURLSessionTask*) getVerificationRequestsWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceVerificationRequest_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceVerificationRequest_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) verifyRequestWithCode: (NSString*) code
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/verification/requests/{code}/responses"];
