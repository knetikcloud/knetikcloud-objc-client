#import "JSAPIStoreSubscriptionsApi.h"
...
@interface JSAPIStoreSubscriptionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIStoreSubscriptionsApi

NSString* kJSAPIStoreSubscriptionsApiErrorDomain = @"JSAPIStoreSubscriptionsApiErrorDomain";
NSInteger kJSAPIStoreSubscriptionsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createSubscriptionWithSubscriptionResource: (JSAPISubscriptionResource*) subscriptionResource
    ...
    bodyParam = subscriptionResource;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPISubscriptionResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPISubscriptionResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createSubscriptionTemplateWithSubscriptionTemplateResource: (JSAPISubscriptionTemplateResource*) subscriptionTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/templates"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPISubscriptionTemplateResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPISubscriptionTemplateResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteSubscriptionWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIStoreSubscriptionsApiErrorDomain code:kJSAPIStoreSubscriptionsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/{id}/plans/{plan_id}"];
...
-(NSURLSessionTask*) deleteSubscriptionTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/templates/{id}"];
...
-(NSURLSessionTask*) getSubscriptionWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/{id}"];
...
///
///  @returns JSAPIPageResourceSubscriptionTemplateResource_*
///
-(NSURLSessionTask*) getSubscriptionTemplatesWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceSubscriptionTemplateResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceSubscriptionTemplateResource_*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceSubscriptionResource_*
///
-(NSURLSessionTask*) getSubscriptionsWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceSubscriptionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceSubscriptionResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) processSubscriptionsWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/process"];
