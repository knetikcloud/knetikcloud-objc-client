#import "JSAPIUsersFriendshipsApi.h"
...
@implementation JSAPIUsersFriendshipsApi

NSString* kJSAPIUsersFriendshipsApiErrorDomain = @"JSAPIUsersFriendshipsApiErrorDomain";
NSInteger kJSAPIUsersFriendshipsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addFriendWithUserId: (NSString*) userId
    ...
    if (userId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIUsersFriendshipsApiErrorDomain code:kJSAPIUsersFriendshipsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/friends/{id}"];
...
///
///  @returns JSAPIPageResourceSimpleUserResource_*
///
-(NSURLSessionTask*) getFriendsWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/friends"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceSimpleUserResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceSimpleUserResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getInviteTokenWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/invite-token"];
...
-(NSURLSessionTask*) getInvitesWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/invites"];
...
-(NSURLSessionTask*) redeemFriendshipTokenWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/friends/tokens"];
