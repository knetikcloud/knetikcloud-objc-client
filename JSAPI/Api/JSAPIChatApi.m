...
@interface JSAPIChatApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIChatApi

NSString* kJSAPIChatApiErrorDomain = @"JSAPIChatApiErrorDomain";
NSInteger kJSAPIChatApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) acknowledgeChatMessageWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIChatApiErrorDomain code:kJSAPIChatApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/threads/{id}/acknowledge"];
...
-(NSURLSessionTask*) addChatMessageBlacklistWithBlacklistedUserId: (NSNumber*) blacklistedUserId
    ...
    if (blacklistedUserId == nil) {
        NSParameterAssert(blacklistedUserId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"blacklistedUserId"] };
            NSError* error = [NSError errorWithDomain:kJSAPIChatApiErrorDomain code:kJSAPIChatApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/users/{id}/blacklist/{blacklisted_user_id}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (blacklistedUserId != nil) {
        pathParams[@"blacklisted_user_id"] = blacklistedUserId;
    }
    if (_id != nil) {
        pathParams[@"id"] = _id;
    }
...
-(NSURLSessionTask*) deleteChatMessageWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/messages/{id}"];
...
-(NSURLSessionTask*) getChatMessageBlacklistWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/users/{id}/blacklist"];
...
///
///  @returns JSAPIPageResourceChatUserThreadResource_*
///
-(NSURLSessionTask*) getChatThreadsWithSize: (NSNumber*) size
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/threads"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceChatUserThreadResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceChatUserThreadResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDirectMessagesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/users/{id}/messages"];
...
-(NSURLSessionTask*) getThreadMessagesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/threads/{id}/messages"];
...
-(NSURLSessionTask*) getTopicMessagesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/chat/topics/{id}/messages"];
