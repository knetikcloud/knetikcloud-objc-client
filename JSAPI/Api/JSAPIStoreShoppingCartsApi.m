#import "JSAPIStoreShoppingCartsApi.h"
...
@implementation JSAPIStoreShoppingCartsApi

NSString* kJSAPIStoreShoppingCartsApiErrorDomain = @"JSAPIStoreShoppingCartsApiErrorDomain";
NSInteger kJSAPIStoreShoppingCartsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addCustomDiscountWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIStoreShoppingCartsApiErrorDomain code:kJSAPIStoreShoppingCartsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/custom-discounts"];
...
-(NSURLSessionTask*) addDiscountToCartWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/discounts"];
...
-(NSURLSessionTask*) addItemToCartWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/items"];
...
-(NSURLSessionTask*) getCartWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPICart*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPICart*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPIPageResourceCartSummary_*
///
-(NSURLSessionTask*) getCartsWithFilterOwnerId: (NSNumber*) filterOwnerId
    ...
    if (filterOwnerId != nil) {
        queryParams[@"filter_owner_id"] = filterOwnerId;
    }
    if (size != nil) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceCartSummary_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceCartSummary_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getShippableWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/shippable"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPICartShippableResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPICartShippableResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getShippingCountriesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/countries"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPISampleCountriesResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPISampleCountriesResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) removeDiscountFromCartWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/discounts/{code}"];
...
-(NSURLSessionTask*) setCartCurrencyWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/currency"];
...
-(NSURLSessionTask*) setCartOwnerWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/owner"];
...
-(NSURLSessionTask*) updateShippingAddressWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carts/{id}/shipping-address"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = cartShippingAddressRequest;
