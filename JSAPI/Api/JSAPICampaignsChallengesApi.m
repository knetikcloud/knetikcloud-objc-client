#import "JSAPICampaignsChallengesApi.h"
...
@interface JSAPICampaignsChallengesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPICampaignsChallengesApi

NSString* kJSAPICampaignsChallengesApiErrorDomain = @"JSAPICampaignsChallengesApiErrorDomain";
NSInteger kJSAPICampaignsChallengesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createChallengeWithChallengeResource: (JSAPIChallengeResource*) challengeResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIChallengeResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIChallengeResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createChallengeActivityWithChallengeId: (NSNumber*) challengeId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/{challenge_id}/activities"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = challengeActivityResource;
...
-(NSURLSessionTask*) createChallengeActivityTemplateWithChallengeActivityTemplateResource: (JSAPITemplateResource*) challengeActivityTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenge-activities/templates"];
...
-(NSURLSessionTask*) createChallengeTemplateWithChallengeTemplateResource: (JSAPITemplateResource*) challengeTemplateResource
    completionHandler: (void (^)(JSAPITemplateResource* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/templates"];
...
-(NSURLSessionTask*) deleteChallengeWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/{id}"];
...
-(NSURLSessionTask*) deleteChallengeActivityTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenge-activities/templates/{id}"];
...
-(NSURLSessionTask*) deleteChallengeEventWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/events/{id}"];
...
-(NSURLSessionTask*) deleteChallengeTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/templates/{id}"];
...
///
///  @returns JSAPIPageResourceBareChallengeActivityResource_*
///
-(NSURLSessionTask*) getChallengeActivitiesWithChallengeId: (NSNumber*) challengeId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceBareChallengeActivityResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceBareChallengeActivityResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getChallengeEventWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIChallengeEventResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIChallengeEventResource*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceChallengeEventResource_*
///
-(NSURLSessionTask*) getChallengeEventsWithFilterStartDate: (NSString*) filterStartDate
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/challenges/events"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceChallengeEventResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceChallengeEventResource_*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceChallengeResource_*
///
-(NSURLSessionTask*) getChallengesWithFilterActiveCampaign: (NSNumber*) filterActiveCampaign
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceChallengeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceChallengeResource_*)data, error);
                                }
                            }];
}
