#import "JSAPIUtilMaintenanceApi.h"
...
@interface JSAPIUtilMaintenanceApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIUtilMaintenanceApi

NSString* kJSAPIUtilMaintenanceApiErrorDomain = @"JSAPIUtilMaintenanceApiErrorDomain";
NSInteger kJSAPIUtilMaintenanceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getMaintenanceWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIMaintenance*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIMaintenance*)data, error);
                                }
                            }];
}
