...
@interface JSAPIPaymentsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIPaymentsApi

NSString* kJSAPIPaymentsApiErrorDomain = @"JSAPIPaymentsApiErrorDomain";
NSInteger kJSAPIPaymentsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createPaymentMethodWithUserId: (NSNumber*) userId
    ...
    if (userId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIPaymentsApiErrorDomain code:kJSAPIPaymentsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/payment-methods"];
...
-(NSURLSessionTask*) deletePaymentMethodWithUserId: (NSNumber*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/payment-methods/{id}"];
...
-(NSURLSessionTask*) getPaymentMethodTypeWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/payment/types/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPaymentMethodTypeResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPaymentMethodTypeResource*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPIPageResourcePaymentMethodTypeResource_*
///
-(NSURLSessionTask*) getPaymentMethodTypesWithFilterName: (NSString*) filterName
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/payment/types"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourcePaymentMethodTypeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourcePaymentMethodTypeResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) paymentAuthorizationWithRequest: (JSAPIPaymentAuthorizationResource*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/payment/authorizations"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPaymentAuthorizationResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPaymentAuthorizationResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) paymentCaptureWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/payment/authorizations/{id}/capture"];
