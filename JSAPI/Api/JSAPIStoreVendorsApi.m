...
@interface JSAPIStoreVendorsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIStoreVendorsApi

NSString* kJSAPIStoreVendorsApiErrorDomain = @"JSAPIStoreVendorsApiErrorDomain";
NSInteger kJSAPIStoreVendorsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createVendorWithVendor: (JSAPIVendorResource*) vendor
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vendors"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIVendorResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIVendorResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createVendorTemplateWithVendorTemplateResource: (JSAPIItemTemplateResource*) vendorTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vendors/templates"];
...
-(NSURLSessionTask*) deleteVendorWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIStoreVendorsApiErrorDomain code:kJSAPIStoreVendorsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vendors/{id}"];
...
-(NSURLSessionTask*) deleteVendorTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vendors/templates/{id}"];
...
///
///  @returns JSAPIPageResourceVendorResource_*
///
-(NSURLSessionTask*) getVendorsWithFilterName: (NSString*) filterName
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceVendorResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceVendorResource_*)data, error);
                                }
                            }];
}
