...
@interface JSAPIStoreBundlesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIStoreBundlesApi

NSString* kJSAPIStoreBundlesApiErrorDomain = @"JSAPIStoreBundlesApiErrorDomain";
NSInteger kJSAPIStoreBundlesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createBundleItemWithCascade: (NSNumber*) cascade
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/store/bundles"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIBundleItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIBundleItem*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createBundleTemplateWithBundleTemplateResource: (JSAPIItemTemplateResource*) bundleTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/store/bundles/templates"];
...
-(NSURLSessionTask*) deleteBundleItemWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIStoreBundlesApiErrorDomain code:kJSAPIStoreBundlesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/store/bundles/{id}"];
...
-(NSURLSessionTask*) deleteBundleTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/store/bundles/templates/{id}"];
