...
@interface JSAPIGamificationLevelingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIGamificationLevelingApi

NSString* kJSAPIGamificationLevelingApiErrorDomain = @"JSAPIGamificationLevelingApiErrorDomain";
NSInteger kJSAPIGamificationLevelingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createLevelWithLevel: (JSAPILevelingResource*) level
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/leveling"];
...
-(NSURLSessionTask*) deleteLevelWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/leveling/{name}"];
...
///
///  @returns JSAPIPageResourceLevelingResource_*
///
-(NSURLSessionTask*) getLevelsWithFilterName: (NSString*) filterName
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceLevelingResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceLevelingResource_*)data, error);
                                }
                            }];
}
...
///  @param name The level schema name 
///
///  @returns JSAPIUserLevelingResource*
///
-(NSURLSessionTask*) getUserLevelWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/leveling/{name}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIUserLevelingResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIUserLevelingResource*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPIPageResourceUserLevelingResource_*
///
-(NSURLSessionTask*) getUserLevelsWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/leveling"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceUserLevelingResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceUserLevelingResource_*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) incrementProgressWithUserId: (NSNumber*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/leveling/{name}/progress"];
