...
@interface JSAPILevelingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPILevelingApi

NSString* kJSAPILevelingApiErrorDomain = @"JSAPILevelingApiErrorDomain";
NSInteger kJSAPILevelingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createLevelingTemplateWithLevelingTemplateResource: (JSAPITemplateResource*) levelingTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/leveling/templates"];
    ...
    bodyParam = levelingTemplateResource;
...
-(NSURLSessionTask*) deleteLevelingTemplateWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPILevelingApiErrorDomain code:kJSAPILevelingApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/leveling/templates/{id}"];
