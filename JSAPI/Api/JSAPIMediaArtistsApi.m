...
@interface JSAPIMediaArtistsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIMediaArtistsApi

NSString* kJSAPIMediaArtistsApiErrorDomain = @"JSAPIMediaArtistsApiErrorDomain";
NSInteger kJSAPIMediaArtistsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addArtistWithArtistResource: (JSAPIArtistResource*) artistResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/artists"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIArtistResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIArtistResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) createArtistTemplateWithArtistTemplateResource: (JSAPITemplateResource*) artistTemplateResource
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/artists/templates"];
...
-(NSURLSessionTask*) deleteArtistWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIMediaArtistsApiErrorDomain code:kJSAPIMediaArtistsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/artists/{id}"];
...
-(NSURLSessionTask*) deleteArtistTemplateWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/media/artists/templates/{id}"];
...
-(NSURLSessionTask*) getArtistWithId: (NSNumber*) _id
    ...
    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (showContributions != nil) {
        queryParams[@"show_contributions"] = showContributions;
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceArtistResource_*
///
-(NSURLSessionTask*) getArtistsWithFilterArtistsByName: (NSString*) filterArtistsByName
    ...
    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (filterArtistsByName != nil) {
        queryParams[@"filter_artists_by_name"] = filterArtistsByName;
    }
    if (size != nil) {
        queryParams[@"size"] = size;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceArtistResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceArtistResource_*)data, error);
                                }
                            }];
}
