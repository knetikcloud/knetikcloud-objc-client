...
@class JSAPICountryResource;



@protocol JSAPIPageResourceCountryResource_
@end

@interface JSAPIPageResourceCountryResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPICountryResource>* content;
