...
@class JSAPIActivityOccurrenceResource;



@protocol JSAPIPageResourceActivityOccurrenceResource_
@end

@interface JSAPIPageResourceActivityOccurrenceResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIActivityOccurrenceResource>* content;
