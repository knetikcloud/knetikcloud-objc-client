...
@protocol JSAPIPageResourceTemplateResource_
@end

@interface JSAPIPageResourceTemplateResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPITemplateResource>* content;
