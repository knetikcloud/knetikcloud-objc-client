...
@class JSAPIAchievementDefinitionResource;



@protocol JSAPIPageResourceAchievementDefinitionResource_
@end

@interface JSAPIPageResourceAchievementDefinitionResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIAchievementDefinitionResource>* content;
