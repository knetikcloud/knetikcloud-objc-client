...
@class JSAPIOAuth2ProviderResource;



@protocol JSAPIPageResourceOAuth2ProviderResource_
@end

@interface JSAPIPageResourceOAuth2ProviderResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIOAuth2ProviderResource>* content;
