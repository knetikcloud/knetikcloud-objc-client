...
@class JSAPIFlagResource;



@protocol JSAPIPageResourceFlagResource_
@end

@interface JSAPIPageResourceFlagResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIFlagResource>* content;
