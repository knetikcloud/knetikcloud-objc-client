...
@class JSAPIArticleResource;



@protocol JSAPIPageResourceArticleResource_
@end

@interface JSAPIPageResourceArticleResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIArticleResource>* content;
