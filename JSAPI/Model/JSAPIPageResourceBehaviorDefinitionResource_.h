...
@class JSAPIBehaviorDefinitionResource;



@protocol JSAPIPageResourceBehaviorDefinitionResource_
@end

@interface JSAPIPageResourceBehaviorDefinitionResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIBehaviorDefinitionResource>* content;
