...
@protocol JSAPIPageResourcePaymentMethodResource_
@end

@interface JSAPIPageResourcePaymentMethodResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIPaymentMethodResource>* content;
