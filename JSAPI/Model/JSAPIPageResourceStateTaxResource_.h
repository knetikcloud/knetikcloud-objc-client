...
@class JSAPIStateTaxResource;



@protocol JSAPIPageResourceStateTaxResource_
@end

@interface JSAPIPageResourceStateTaxResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIStateTaxResource>* content;
