...
@class JSAPIObjectResource;



@protocol JSAPIPageResourceObjectResource_
@end

@interface JSAPIPageResourceObjectResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIObjectResource>* content;
