...
@class JSAPIChallengeEventResource;



@protocol JSAPIPageResourceChallengeEventResource_
@end

@interface JSAPIPageResourceChallengeEventResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIChallengeEventResource>* content;
