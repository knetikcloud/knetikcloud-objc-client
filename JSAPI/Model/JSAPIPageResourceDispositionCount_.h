...
@class JSAPIDispositionCount;



@protocol JSAPIPageResourceDispositionCount_
@end

@interface JSAPIPageResourceDispositionCount_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIDispositionCount>* content;
