...
@class JSAPIQuestionResource;



@protocol JSAPIPageResourceQuestionResource_
@end

@interface JSAPIPageResourceQuestionResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIQuestionResource>* content;
