...
@class JSAPIDeltaResource;



@protocol JSAPIPageResourceDeltaResource_
@end

@interface JSAPIPageResourceDeltaResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIDeltaResource>* content;
