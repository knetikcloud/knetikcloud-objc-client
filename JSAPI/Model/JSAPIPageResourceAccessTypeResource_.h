...
@class JSAPIAccessTypeResource;
@protocol JSAPIOrder;
@class JSAPIOrder;



@protocol JSAPIPageResourceAccessTypeResource_
@end

@interface JSAPIPageResourceAccessTypeResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIAccessTypeResource>* content;
