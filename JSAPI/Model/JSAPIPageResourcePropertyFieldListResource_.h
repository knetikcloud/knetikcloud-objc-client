...
@protocol JSAPIPageResourcePropertyFieldListResource_
@end

@interface JSAPIPageResourcePropertyFieldListResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIPropertyFieldListResource>* content;
