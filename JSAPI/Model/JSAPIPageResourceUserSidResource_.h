...
@class JSAPIUserSidResource;



@protocol JSAPIPageResourceUserSidResource_
@end

@interface JSAPIPageResourceUserSidResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIUserSidResource>* content;
