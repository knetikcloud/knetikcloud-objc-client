...
@protocol JSAPIPageResourceSimpleUserResource_
@end

@interface JSAPIPageResourceSimpleUserResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPISimpleUserResource>* content;
