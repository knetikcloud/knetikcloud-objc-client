...
@class JSAPICategoryResource;



@protocol JSAPIPageResourceCategoryResource_
@end

@interface JSAPIPageResourceCategoryResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPICategoryResource>* content;
