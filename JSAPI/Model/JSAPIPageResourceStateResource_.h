...
@class JSAPIStateResource;



@protocol JSAPIPageResourceStateResource_
@end

@interface JSAPIPageResourceStateResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIStateResource>* content;
