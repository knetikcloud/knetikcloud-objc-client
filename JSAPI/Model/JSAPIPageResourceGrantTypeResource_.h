...
@protocol JSAPIGrantTypeResource;
@class JSAPIGrantTypeResource;



@protocol JSAPIPageResourceGrantTypeResource_
@end

@interface JSAPIPageResourceGrantTypeResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIGrantTypeResource>* content;
