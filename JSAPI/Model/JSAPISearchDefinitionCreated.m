#import "JSAPISearchDefinitionCreated.h"

@implementation JSAPISearchDefinitionCreated
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"definition": @"definition" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"definition"];
