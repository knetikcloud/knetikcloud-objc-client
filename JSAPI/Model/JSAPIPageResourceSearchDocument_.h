...
@protocol JSAPISearchDocument;
@class JSAPISearchDocument;



@protocol JSAPIPageResourceSearchDocument_
@end

@interface JSAPIPageResourceSearchDocument_ : JSAPIObject


@property(nonatomic) NSArray<JSAPISearchDocument>* content;
