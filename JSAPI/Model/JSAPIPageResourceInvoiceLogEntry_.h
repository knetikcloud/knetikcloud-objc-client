...
@protocol JSAPIPageResourceInvoiceLogEntry_
@end

@interface JSAPIPageResourceInvoiceLogEntry_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIInvoiceLogEntry>* content;
