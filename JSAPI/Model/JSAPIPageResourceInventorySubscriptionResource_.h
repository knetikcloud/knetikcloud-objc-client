...
@class JSAPIInventorySubscriptionResource;



@protocol JSAPIPageResourceInventorySubscriptionResource_
@end

@interface JSAPIPageResourceInventorySubscriptionResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIInventorySubscriptionResource>* content;
