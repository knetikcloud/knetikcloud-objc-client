...
@class JSAPIVideoResource;



@protocol JSAPIPageResourceVideoResource_
@end

@interface JSAPIPageResourceVideoResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIVideoResource>* content;
