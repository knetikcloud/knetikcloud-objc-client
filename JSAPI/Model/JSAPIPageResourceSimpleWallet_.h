...
@class JSAPISimpleWallet;



@protocol JSAPIPageResourceSimpleWallet_
@end

@interface JSAPIPageResourceSimpleWallet_ : JSAPIObject


@property(nonatomic) NSArray<JSAPISimpleWallet>* content;
