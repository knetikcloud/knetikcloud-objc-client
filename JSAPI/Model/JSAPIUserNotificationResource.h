...
@interface JSAPIUserNotificationResource : JSAPIObject
...
/* The date this notification was first retrieved [optional]
 */
@property(nonatomic) NSNumber* retrieveDate;
/* The date this notification was sent [optional]
 */
@property(nonatomic) NSNumber* sendDate;
/* The user's status for this notification [optional]
 */
