...
@protocol JSAPIPageResourcePaymentMethodTypeResource_
@end

@interface JSAPIPageResourcePaymentMethodTypeResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIPaymentMethodTypeResource>* content;
