...
@protocol JSAPIPageResourceExpressionResource_
@end

@interface JSAPIPageResourceExpressionResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIExpressionResource>* content;
