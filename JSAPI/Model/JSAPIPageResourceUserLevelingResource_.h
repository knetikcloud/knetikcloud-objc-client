...
@class JSAPIUserLevelingResource;



@protocol JSAPIPageResourceUserLevelingResource_
@end

@interface JSAPIPageResourceUserLevelingResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPIUserLevelingResource>* content;
