#import "JSAPIDefaultConfiguration.h"
#import "JSAPIBasicAuthTokenProvider.h"
#import "JSAPILogger.h"

@interface JSAPIDefaultConfiguration ()
...
@implementation JSAPIDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static JSAPIDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        ...
        _logger = [JSAPILogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [JSAPIBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
